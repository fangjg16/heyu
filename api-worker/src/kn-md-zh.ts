...
const PHRASES: Array<[RegExp, string]> = [
  ...
  [/\bBehavioral Shifts?\b/giu, "行为变化"],
  [/\bTechnology Trends?\b/giu, "技术趋势"],
  [/\bRegulatory Trends?\b/giu, "监管趋势"],
  [/\bMarket Trends?\b/giu, "市场趋势"],
  [/\bInvestment Activity\b/giu, "投资动态"],
  [/\bExpert Predictions?\b/giu, "专家预判"],
  [/\bTiming Assessment\b/giu, "时机判断"],
  [/\bTailwinds?\b/giu, "顺风"],
  [/\bHeadwinds?\b/giu, "逆风"],
  ...
  [/\bResearch Gate\b/giu, "研究闸门"],
  [/\bYellow Light\b/giu, "黄灯"],
  [/\bGreen Light\b/giu, "绿灯"],
  [/\bRed Light\b/giu, "红灯"],
  [/\bConditional Proceed\b/giu, "有条件继续"],
  [/\bOverall confidence\b/giu, "总体把握"],
  [/\bMarket size\b/giu, "市场规模"],
  [/\bCompetitive advantage\b/giu, "竞争优势"],
  [/\bBusiness model clarity\b/giu, "商业模式清晰度"],
  [/\bFounder-market fit\b/giu, "创始人与市场匹配"],
  [/\bFeasibility\b/giu, "可行性"],
  [/\bScore\s*\(\s*1\s*[–—-]\s*10\s*\)/giu, "分数"],

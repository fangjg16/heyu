...
const SECTION_FILE_BOOST: Record<string, RegExp> = {
  ...
  "industry-overview": /行业|市场|赛道|定义|规模|industry|market/iu,
  "industry-demand": /需求|渗透|驱动|约束|付费|采购/iu,
  "industry-value-chain": /价值链|利润池|产业链|渠道/iu,
  "industry-competition-structure": /竞争|参与者|份额|格局|竞品/iu,
  "industry-outlook": /趋势|技术|监管|替代/iu,
  ...
  "business-overview": /业务|边界|客户|模式/iu,
  "product-situation": /产品|功能|形态/iu,
  "technology-situation": /技术|研发|专利|知识产权/iu,
  "commercial-model": /商业模式|定价|交易|单位经济/iu,
  "core-competitiveness": /竞争力|护城河|核心能力/iu,
  ...
  "company-team": /股权|股东|团队|背景|创始|组织/iu,
  "company-background": /背景|调查|股权|股东|ubo|工商/iu,
  ...
  "risk-return": /估值|回报|风险|主张|核验|IRR|risk|return/iu,
  ...
  "assumption-validation": /声明|假设|主张|审计|claim/iu,
...
const SECTION_RETRIEVAL_QUERY: Record<string, string> = {
  ...
  "industry-overview": "行业定义 坐标 规模 增长 历程",
  "industry-demand": "需求 渗透 驱动 约束",
  "industry-value-chain": "价值链 利润池 产业链",
  "industry-competition-structure": "竞争结构 参与者 份额",
  ...
  "business-overview": "业务 边界 客户 模式",
  "product-situation": "产品 功能 形态",
  "technology-situation": "技术 研发 知识产权",
  "commercial-model": "商业模式 定价 交易闭环",
  "core-competitiveness": "核心能力 竞争力",

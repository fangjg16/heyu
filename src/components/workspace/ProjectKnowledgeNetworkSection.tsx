      ...
      {view === "chapters" ? (
        <div className="space-y-3">
          <div className="flex items-end gap-2.5 rounded-2xl border border-[rgba(78,66,57,0.1)] bg-[rgba(255,252,248,0.9)] p-3">
            <textarea
              ...
              className="min-h-[52px] flex-1 resize-y rounded-xl border border-[rgba(78,66,57,0.12)] bg-white/80 px-3.5 py-2.5 text-[13px] leading-relaxed text-[#1F2423] outline-none placeholder:text-[#969E9A] focus:border-[rgba(163,38,44,0.35)] disabled:cursor-not-allowed disabled:opacity-60"
            />
            <button
              type="button"
              ...
              className="h-10 shrink-0 rounded-[9px] bg-[#A3262C] px-4 text-[13px] font-medium text-white transition-colors hover:bg-[#8B1F24] disabled:cursor-not-allowed disabled:opacity-50"
            >
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ...
                        : "bg-transparent font-normal text-[#59625F] hover:bg-[rgba(163,38,44,0.04)]",
                    )}
                  >
                    {g.label}
                  </button>
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      active
                        ? "border-[#A3262C] font-semibold text-[#A3262C]"
                ...
                <div className="lg:sticky lg:top-4">
                  <div className="mb-[18px] border-b border-[rgba(78,66,57,0.1)] pb-[18px]">
                    <button
                      ...
                      className="h-9 w-full whitespace-nowrap rounded-[9px] border border-[rgba(163,38,44,0.3)] bg-transparent px-2.5 text-[12px] font-medium text-[#A3262C] transition-colors hover:bg-[#F7EDEE] disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      {sectionBusy
                        ? "生成草案中…"
                  ...
                  {sectionId !== "questions" ? (
                    <>
                      ...
                      <button
                        type="button"
                        onClick={goToQuestions}
                        className="h-[34px] border-none bg-transparent p-0 text-[12px] font-medium text-[#A3262C]"
                      >
                        查看全部待确认问题 →
                      </button>
                    </>
                  ...
                  <button
                    type="button"
                    onClick={focusChat}
                    className="mt-4 h-9 w-full rounded-[9px] border border-[rgba(163,38,44,0.3)] bg-transparent text-[12px] font-medium text-[#A3262C] transition-colors hover:bg-[#F7EDEE]"
                  >
                    围绕本章提问
                  </button>
                </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-[rgba(78,66,57,0.1)] bg-[rgba(255,252,248,0.76)]">
          <div className="border-b border-[rgba(78,66,57,0.1)] px-8 py-7">
            <div className="text-[11px] tracking-wide text-[#A3262C]">
              知识网络资料
            </div>
          ...
          <div ref={sourcesPaneRef} className="px-8 py-[30px]">
            ...
            {loadingSources ? (
              ...
              <div
                className="kn-sources-html text-[13px] leading-[1.65] text-[#1F2423] [&_table]:w-full [&_table]:border-collapse [&_tbody_td:first-child]:whitespace-nowrap [&_tbody_td:first-child]:font-semibold [&_tbody_td:first-child]:text-[#A3262C] [&_td]:border [&_td]:border-[rgba(78,66,57,0.12)] [&_td]:px-3.5 [&_td]:py-3 [&_th]:whitespace-nowrap [&_th]:border [&_th]:border-[rgba(78,66,57,0.12)] [&_th]:bg-[rgba(78,66,57,0.05)] [&_th]:px-3.5 [&_th]:py-3 [&_th]:text-left [&_th]:text-[12px] [&_th]:font-semibold [&_th]:text-[#59625F] [&_tr.kn-source-flash]:bg-[rgba(163,38,44,0.08)] [&_tr]:scroll-mt-24"
        ...
        <div className="overflow-hidden rounded-2xl border border-[rgba(78,66,57,0.1)] bg-[rgba(255,252,248,0.76)]">
          ...
          {versionsError ? (
            <p className="mx-6 mt-4 rounded-xl border border-[rgba(163,38,44,0.25)] bg-[rgba(163,38,44,0.06)] px-3.5 py-2 text-[12.5px] text-[#A3262C]">
              {versionsError}
            </p>
          ) : null}
                      ...
                      >
                        ...
                        <div className="text-right text-[12px] text-[#969E9A]">
                          {v.archivedAt
                            ...
                            : "—"}
                          <div className="mt-0.5 text-[#A3262C]">查看</div>
                        </div>
                      </button>
                    </li>
                  );

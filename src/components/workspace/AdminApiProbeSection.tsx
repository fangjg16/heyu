...
const RISK_CLASS: Record<ApiRisk, string> = {
  ...
  destructive: "bg-[rgba(163,38,44,0.12)] text-[#A3262C]",
  llm: "bg-[rgba(163,38,44,0.1)] text-[#7A1C20]",
    ...
    <div className="overflow-hidden rounded-[18px] border border-[rgba(78,66,57,0.1)] bg-[rgba(255,252,248,0.82)]">
      <div className="flex flex-wrap items-start justify-between gap-3 border-b border-[rgba(78,66,57,0.1)] px-5 py-4">
        <div className="flex items-start gap-2">
          <Activity className="mt-0.5 h-4 w-4 text-[#A3262C]" strokeWidth={2} />
          <div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <input
            ...
            className="h-9 min-w-[220px] rounded-lg border border-[rgba(78,66,57,0.14)] bg-white/80 px-3 text-[12.5px] outline-none focus:border-[rgba(163,38,44,0.35)]"
          />
          ...
          <button
            ...
            disabled={running}
            className="inline-flex h-9 items-center gap-1.5 rounded-lg bg-[#A3262C] px-3.5 text-[12.5px] font-medium text-white hover:bg-[#8B1F24] disabled:opacity-45"
          >
            {running ? (
                              ...
                              className={cn(
                                ...
                                r.skipped
                                  ...
                                  : r.ok
                                    ...
                                    : "bg-[rgba(163,38,44,0.12)] text-[#A3262C]",
                              )}
                            >
                              {r.skipped
                                ? "跳过"
            ...
            <div className="rounded-xl border border-[rgba(78,66,57,0.1)] bg-white/70 p-4">
              <div className="flex flex-wrap items-start justify-between gap-2">
                ...
                <button
                  ...
                  disabled={running}
                  className="inline-flex h-8 items-center gap-1.5 rounded-md border border-[rgba(163,38,44,0.3)] px-3 text-[12px] font-medium text-[#A3262C] hover:bg-[#F7EDEE] disabled:opacity-45"
                >
                  <Play className="h-3.5 w-3.5" />
                  探测本条
                </button>
          ...
          <div className="rounded-xl border border-[rgba(78,66,57,0.1)] bg-white/70 p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              ...
              <input
                ...
                className="h-9 min-w-[240px] flex-1 rounded-lg border border-[rgba(78,66,57,0.14)] bg-white px-3 font-mono text-[12.5px] outline-none focus:border-[rgba(163,38,44,0.35)]"
                placeholder="/api/..."
              />
              <button
                type="button"
            ...
            {manualMethod !== "GET" && manualMethod !== "DELETE" ? (
              <textarea
                ...
                className="mt-2 w-full resize-y rounded-xl border border-[rgba(78,66,57,0.12)] bg-white px-3 py-2 font-mono text-[12px] outline-none focus:border-[rgba(163,38,44,0.35)]"
              />
            ) : null}
            {manualResult ? (

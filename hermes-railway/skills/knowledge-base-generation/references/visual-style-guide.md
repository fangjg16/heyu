...
- **`.timeline`** + **`.tl-item`** — left-rail vertical timeline used by Section 八's three timeline sub-blocks and inline mini-timelines. 2px rail in `--burgundy-15`, dots in solid `--burgundy` with a 3px `--paper` ring.
